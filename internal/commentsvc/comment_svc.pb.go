...
func (m *OperatorRequest) GetObjId() int64 {
	if m != nil {
		return m.ObjId
	}
	return 0
...
func (m *OperatorRequest) GetObjType() int32 {
	if m != nil {
		return m.ObjType
	}
	return 0
...
func (m *OperatorRequest) GetCommentId() int64 {
	if m != nil {
		return m.CommentId
	}
	return 0
...
func (m *OperatorRequest) GetUid() int64 {
	if m != nil {
		return m.Uid
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*OperatorRequest)(nil), "commentsvc.OperatorRequest")
...
var fileDescriptor_b532af45d298f2ba = []byte{
	...
	,
}
...
type CommentSvcClient interface {
	...
	LikeComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	HateComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	DeleteComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
...
func (c *commentSvcClient) LikeComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
...
func (c *commentSvcClient) HateComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
...
func (c *commentSvcClient) DeleteComment(ctx context.Context, in *OperatorRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
...
type CommentSvcServer interface {
	...
	LikeComment(context.Context, *OperatorRequest) (*EmptyResponse, error)
	HateComment(context.Context, *OperatorRequest) (*EmptyResponse, error)
	DeleteComment(context.Context, *OperatorRequest) (*EmptyResponse, error)
...
func (*UnimplementedCommentSvcServer) LikeComment(ctx context.Context, req *OperatorRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LikeComment not implemented")
}
func (*UnimplementedCommentSvcServer) HateComment(ctx context.Context, req *OperatorRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HateComment not implemented")
}
func (*UnimplementedCommentSvcServer) DeleteComment(ctx context.Context, req *OperatorRequest) (*EmptyResponse, error) {
...
func _CommentSvc_LikeComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentSvcServer).LikeComment(ctx, req.(*OperatorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CommentSvc_HateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentSvcServer).HateComment(ctx, req.(*OperatorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CommentSvc_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentSvcServer).DeleteComment(ctx, req.(*OperatorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
